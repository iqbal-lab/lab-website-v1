...
<div class="team-list">
	{#each members as member}
		<div class="team-member">
			<img src={member.photo} alt="Photo of {member.name}" class="team-photo" />
			<div class="team-bio">
				<div class="fw-bold fs-5">{member.name}</div>
				<p class="mt-1">{member.description}</p>
			</div>
		</div>
	{/each}
</div>
